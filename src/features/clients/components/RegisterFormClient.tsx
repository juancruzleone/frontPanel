...
interface RegisterClientFormProps {
    ...
    formData: RegisterClientFormData
                    ...
                    <div className={styles.formGroup} key={name}>
                        ...
                        <div className={styles.inputWrapper}>
                            <input
                                ...
                                id={name}
                                name={name}
                                value={formData[name as keyof RegisterClientFormData] || ""}
                                onChange={handleInputChange}
                                onBlur={handleInputBlur}
                                disabled={isSubmitting}
                                placeholder={t('clients.enterField', { field: label.toLowerCase() })}
                                ...
                                <button
                                    ...
                                    aria-label={
                                        (name === "password" ? showPassword : showConfirmPassword)
                                            ? t('clients.hidePassword')
                                            : t('clients.showPassword')
                                    }
                                >
                                    {(() => {
