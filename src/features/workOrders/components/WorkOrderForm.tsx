        ...
        <div className={styles.formInner}>
          <div className={styles.basicInfoSection}>
            <div className={styles.formGroup}>
              ...
              />
              {showError("titulo") && <span className={styles.inputError}>{formErrors["titulo"]}</span>}
            </div>

            <div className={styles.formGroup}>
              <label>{t('workOrders.description')} *</label>
              <textarea
                name="descripcion"
              ...
              />
              {showError("descripcion") && <span className={styles.inputError}>{formErrors["descripcion"]}</span>}
            </div>

            <div className={styles.formGroup}>
              <label>{t('workOrders.installation')} *</label>
            ...
            <div className={styles.formRow}>
              <div className={styles.formGroup}>
                <label>{t('workOrders.workType')} *</label>
                <HybridSelect
                  name="tipoTrabajo"
              ...
              <div className={styles.formGroup}>
                ...
                />
                {showError("prioridad") && <span className={styles.inputError}>{formErrors["prioridad"]}</span>}
              </div>
            </div>
            ...
            <div className={styles.formGroup}>
              <label>{t('workOrders.observations')}</label>
              <textarea
                name="observaciones"
