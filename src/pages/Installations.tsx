...
import useInstallations, { Installation } from "../features/installations/hooks/useInstallations";
...
const Installations = () => {
  ...
  const { addInstallationType } = useInstallationTypes();
                ...
                <div key={inst._id} className={styles.installationCard}>
                  ...
                  <div className={styles.cardActions}>
                    ...
                    <div className={styles.viewDevicesButton}>
                      <button onClick={() => handleViewDevices(inst)}>
